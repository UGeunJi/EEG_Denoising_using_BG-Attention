...
def prepare_data(EEG_all, noise_all, combin_num, train_per, noise_type):
    ...
    if noise_type == 'EMG':  # Training set will Reuse some of the EEG signal to much the number of EMG
        ...
        EEG_reuse = EEG_all_random[0 : reuse_num, :]      # 컴마의 의미 - 0부터 reuse_num까지 512 모두
    ...
    # print('validation_eeg.shape:', validation_eeg.shape)
    # print('validation_noise.shape:', validation_noise.shape)
